...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://storage.googleapis.com/simility-beacon-bins/ios/ios_recon_v1.616.zip" }
  s.source_files  = "ios_recon_v1.616"
  s.public_header_files = "ios_recon_v1.616/SimilityRecon.h"
  s.ios.vendored_library = "ios_recon_v1.616/libSimilityRecon.a"
